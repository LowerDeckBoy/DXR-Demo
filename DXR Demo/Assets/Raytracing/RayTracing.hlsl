...
StructuredBuffer<VertexConstant> Vertices : register(t2, space0);

ConstantBuffer<SceneConstant> g_sceneCB : register(b0);
ConstantBuffer<CubeConstant> g_cubeCB : register(b1);
...
inline void GenerateCameraRay(uint2 index, out float3 origin, out float3 direction)
{
    ...
    float4 world = mul(float4(screenPos, 0, 1), g_sceneCB.ViewProjection);
