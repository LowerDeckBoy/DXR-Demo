...
D3D12_GRAPHICS_PIPELINE_STATE_DESC PipelineStateObject::CreateState(ID3D12RootSignature* pRootSignature, Shader* pVertexShader, Shader* pPixelShader, std::span<D3D12_INPUT_ELEMENT_DESC> InputLayout)
{
...
D3D12_STATIC_SAMPLER_DESC PipelineStateObject::CreateStaticSampler(uint32_t ShaderRegister, uint32_t RegisterSpace, D3D12_FILTER Filter, D3D12_TEXTURE_ADDRESS_MODE AddressMode, D3D12_COMPARISON_FUNC ComparsionFunc)
{
...
D3D12_SAMPLER_DESC PipelineStateObject::CreateSampler(D3D12_FILTER Filter, D3D12_TEXTURE_ADDRESS_MODE AddressMode, D3D12_COMPARISON_FUNC ComparsionFunc)
{
...
D3D12_ROOT_SIGNATURE_FLAGS PipelineStateObject::SetRootFlags(D3D12_ROOT_SIGNATURE_FLAGS Flags)
{
...
std::array<D3D12_INPUT_ELEMENT_DESC, 5> PipelineStateObject::CreateInputLayout()
{
...
std::array<D3D12_INPUT_ELEMENT_DESC, 2> PipelineStateObject::CreateSkyboxInputLayout()
{
